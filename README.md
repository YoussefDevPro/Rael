...
Rael provides a simple canvas-based API for drawing to the terminal. It supports both character-based and half-block pixel-based rendering, and uses a differential rendering approach to minimize the amount of data sent to the terminal, resulting in a flicker-free experience.

## Features

-   Canvas-based drawing API.
-   Support for both character-based and half-block pixel rendering.
-   Differential rendering for flicker-free output.
-   24-bit color support.

## Usage

Add `rael` to your `Cargo.toml`:
...
Here is a simple example of how to use `rael`:
